...
class ReportTemplateAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Permissions", {"fields": ("is_public", "allowed_users", "allowed_roles")}),
        ("Cache Settings", {"fields": ("enable_cache", "cache_duration")}),
        ("Metadata", {"fields": ("created_by", "is_active", "version"), "classes": ("collapse",)}),
        (
            "System Info",
            {"fields": ("id", "cache_key", "created_at", "updated_at"), "classes": ("collapse",)},
        ),
    )
...
class ReportExecutionAdmin(admin.ModelAdmin):
    ...
    list_filter = ["status", "output_format", "template__report_type", "created_at", "executed_by"]
    search_fields = [
        "template__name",
    ...
    fieldsets = (
        ("Execution Info", {"fields": ("template", "executed_by", "parameters", "output_format")}),
        ("Status & Results", {"fields": ("status", "result_data", "file_path", "error_message")}),
        (
            "Metrics",
            {"fields": ("execution_time_seconds", "rows_processed", "started_at", "completed_at")},
        ),
        ("File Management", {"fields": ("expires_at", "is_expired"), "classes": ("collapse",)}),
        (
            "System Info",
            {"fields": ("id", "cache_key", "created_at", "updated_at"), "classes": ("collapse",)},
        ),
...
class ReportScheduleAdmin(admin.ModelAdmin):
    ...
    list_filter = ["frequency", "status", "template__report_type", "created_at", "created_by"]
    ...
    fieldsets = (
        ("Basic Info", {"fields": ("name", "template", "status")}),
        ("Schedule Configuration", {"fields": ("frequency", "cron_expression")}),
        ("Execution Configuration", {"fields": ("output_format", "parameters")}),
        (
            "Notifications",
            {"fields": ("email_recipients", "send_email_on_success", "send_email_on_failure")},
        ),
        (
            "Statistics",
            {
