    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ...
                            ("terminations", "Relatório de Desligamentos"),
                            ("evaluations", "Relatório de Avaliações"),
                            ("leave_requests", "Relatório de Solicitações de Férias"),
                            ("admissions", "Relatório de Admissões"),
                ...
                (
                    "cache_duration",
                    models.IntegerField(default=300, verbose_name="Duração do Cache (segundos)"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.BooleanField(default=True, verbose_name="Enviar Email em Sucesso"),
                ),
                (
                    "send_email_on_failure",
                    models.BooleanField(default=True, verbose_name="Enviar Email em Falha"),
                ),
                (
                    "status",
                    models.CharField(
                ...
                (
                    "last_execution",
                    models.DateTimeField(blank=True, null=True, verbose_name="Última Execução"),
                ),
                (
                    "next_execution",
                    models.DateTimeField(blank=True, null=True, verbose_name="Próxima Execução"),
                ),
                (
                    "execution_count",
                    models.IntegerField(default=0, verbose_name="Contagem de Execuções"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.FloatField(
                        blank=True, null=True, verbose_name="Tempo de Execução (segundos)"
                    ),
                ),
                (
                    "rows_processed",
                    models.IntegerField(blank=True, null=True, verbose_name="Linhas Processadas"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(blank=True, max_length=200, verbose_name="Nome Personalizado"),
                ),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["report_type", "is_active"], name="reports_rep_report__11a031_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="reporttemplate",
            index=models.Index(
                fields=["created_by", "is_active"], name="reports_rep_created_2b4a9d_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="reportschedule",
            index=models.Index(
                fields=["status", "next_execution"], name="reports_rep_status_092276_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="reportschedule",
            index=models.Index(
                fields=["template", "status"], name="reports_rep_templat_a9968b_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="reportexecution",
            index=models.Index(
                fields=["template", "status"], name="reports_rep_templat_36d6a9_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="reportexecution",
            index=models.Index(
                fields=["executed_by", "created_at"], name="reports_rep_execute_07b8b0_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="reportexecution",
