    ...
    def handle(self, *args, **options):
        ...
        try:
            ...
            if not admin_user:
                self.stdout.write(
                    self.style.WARNING(
                        "No admin user found. Templates will be created without creator."
                    )
                )
                return
        ...
        templates_data = [
            ...
            },
            {
                ...
                "query_config": {"default_filters": {}, "default_ordering": "-hire_date"},
                ...
                "chart_config": {
                    "charts": [
                        ...
                        {"type": "bar", "title": "Admissões por Mês", "data_field": "hire_date"},
                    ]
                },
                "is_public": False,
                "allowed_roles": ["admin", "rh"],
            ...
            },
            {
                ...
                "query_config": {"default_filters": {}, "default_ordering": "-created_at"},
                "output_formats": ["json", "pdf", "excel", "csv"],
                "default_format": "pdf",
                "columns_config": {
                    "visible_columns": [
            ...
            },
            {
                ...
                "query_config": {"default_filters": {}, "default_ordering": "-evaluation_date"},
                "output_formats": ["json", "pdf", "excel"],
                "default_format": "excel",
                "columns_config": {
                    "visible_columns": [
            ...
            },
            {
                ...
                "chart_config": {
                    "charts": [
                        {"type": "bar", "title": "Solicitações por Status", "data_field": "status"},
                        {
                            "type": "line",
            ...
            },
            {
                ...
                "category": categories["Recursos Humanos"],
                "query_config": {"summary_only": True},
        ...
        for template_data in templates_data:
            template, created = ReportTemplate.objects.get_or_create(
                name=template_data["name"], defaults={**template_data, "created_by": admin_user}
            )
            if created:
