    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ...
                            ("avaliacao_superior", "Avaliação do Superior"),
                            ("avaliacao_360", "Avaliação 360°"),
                            ("avaliacao_pares", "Avaliação de Pares"),
                        ],
                        default="avaliacao_superior",
                        max_length=20,
                ...
                (
                    "pontos_melhoria",
                    models.TextField(blank=True, verbose_name="Pontos de Melhoria"),
                ),
                ("metas_objetivos", models.TextField(blank=True, verbose_name="Metas e Objetivos")),
                (
                    "data_limite",
                    models.DateTimeField(blank=True, null=True, verbose_name="Data Limite"),
                ),
                (
                    "data_conclusao",
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        to="evaluations.evaluationtemplate",
            ...
            fields=[
                ...
                (
                    ...
                    models.PositiveIntegerField(
                        default=1, help_text="Ordem de exibição do critério", verbose_name="Ordem"
                    ),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True, verbose_name="Criado em")),
                (
