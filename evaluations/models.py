...
class EvaluationCriteria(models.Model):
    ...
    ordem = models.PositiveIntegerField(
        default=1, verbose_name="Ordem", help_text="Ordem de exibição do critério"
    )
...
class Evaluation(models.Model):
    ...
    # Basic Information
    template = models.ForeignKey(
        EvaluationTemplate, on_delete=models.CASCADE, verbose_name="Template"
    )
    ...
    def __str__(self) -> str:
        return (
            f"{self.avaliado} - {self.template.nome} ({self.periodo_inicio} a {self.periodo_fim})"
        )
...
class EvaluationScore(models.Model):
    ...
    criterio = models.ForeignKey(
        EvaluationCriteria, on_delete=models.CASCADE, verbose_name="Critério"
    )
...
class EvaluationCycle(models.Model):
    ...
    template = models.ForeignKey(
        EvaluationTemplate, on_delete=models.CASCADE, verbose_name="Template Padrão"
    )
