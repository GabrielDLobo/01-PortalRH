...
class EmployeeModelTestCase(TestCase):
    def setUp(self):
        self.user = User.objects.create_user(
            username='staffmodel@test.com', email='staffmodel@test.com',
...
class DepartmentModelTestCase(TestCase):
    def test_employee_count(self):
        ...
        user = User.objects.create_user(
            username='deptmodel@test.com', email='deptmodel@test.com',
            password='testpass123', role='funcionario'
        )
        Employee.objects.create(
            user=user, nome='João Dept', cargo='Dev', setor='TI',
            data_admissao=date(2021, 1, 1), salario='4000.00',
            cpf='11122233344', rg='555666777', telefone='11988887777',
            endereco='Rua X, 1', data_nascimento=date(1992, 3, 3),
        )
...
class EmployeeAPIPermissionTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.hr_user = User.objects.create_user(
            username='staffhr@test.com', email='staffhr@test.com',
            password='testpass123', role='admin_rh'
        )
        self.employee_user = User.objects.create_user(
            username='staffemployee@test.com', email='staffemployee@test.com',
            password='testpass123', role='funcionario'
        )
