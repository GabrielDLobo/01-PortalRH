...
class Employee(models.Model):
    ...
    foto = models.ImageField(
        upload_to="employees/photos/", null=True, blank=True, verbose_name="Foto"
    )
...
class EmployeeDocument(models.Model):
    ...
    employee = models.ForeignKey(
        Employee, on_delete=models.CASCADE, related_name="documents", verbose_name="Funcionário"
    )

    tipo = models.CharField(
        max_length=30, choices=DocumentType.choices, verbose_name="Tipo do Documento"
    )

    nome = models.CharField(max_length=200, verbose_name="Nome do Documento")
    arquivo = models.FileField(upload_to=employee_document_upload_path, verbose_name="Arquivo")
