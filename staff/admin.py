...
class EmployeeAdmin(admin.ModelAdmin):
    list_display = ("nome", "cargo", "setor", "status", "data_admissao", "salario_display")
    ...
    fieldsets = (
        ...
        (
            ...
            {"fields": ("nome", "cpf", "rg", "data_nascimento", "telefone", "endereco", "foto")},
        ),
        (
            "Informações Profissionais",
            {"fields": ("cargo", "setor", "data_admissao", "data_demissao", "salario", "status")},
        ),
        ("Observações", {"fields": ("observacoes",)}),
        (
            "Informações do Sistema",
            {"fields": ("created_at", "updated_at", "years_of_service"), "classes": ("collapse",)},
        ),
    )
