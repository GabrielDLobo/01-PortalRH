    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "data_demissao",
                    models.DateField(blank=True, null=True, verbose_name="Data de Demissão"),
                ),
                (
                    "salario",
                    models.DecimalField(
                ...
                (
                    "foto",
                    models.ImageField(
                        blank=True, null=True, upload_to="employees/photos/", verbose_name="Foto"
                    ),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True, verbose_name="Criado em")),
                ("updated_at", models.DateTimeField(auto_now=True, verbose_name="Atualizado em")),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "arquivo",
                    models.FileField(
                        upload_to=staff.models.employee_document_upload_path, verbose_name="Arquivo"
                    ),
                ),
                ("descricao", models.TextField(blank=True, verbose_name="Descrição")),
                ("created_at", models.DateTimeField(auto_now_add=True, verbose_name="Criado em")),
