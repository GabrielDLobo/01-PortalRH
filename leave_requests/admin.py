...
class LeaveRequestAdmin(admin.ModelAdmin):
    list_display = (
        ...
        "data_inicio",
        "data_fim",
        "dias_solicitados_display",
        "status_display",
        "prioridade",
        "created_at",
    )
    list_filter = ("status", "prioridade", "tipo", "data_inicio", "created_at")
    search_fields = (
        "solicitante__email",
    ...
    ordering = ("-created_at",)
    readonly_fields = ("created_at", "updated_at", "data_aprovacao", "dias_solicitados_display")

    fieldsets = (
        ("Informações da Solicitação", {"fields": ("solicitante", "tipo", "prioridade")}),
        (
            "Detalhes do Período",
            {
                "fields": (
        ...
        (
            "Aprovação",
            {"fields": ("status", "aprovador", "data_aprovacao", "comentario_aprovacao")},
        ),
        (
    ...
    def approve_requests(self, request, queryset):
        ...
        self.message_user(request, f"{approved_count} solicitações foram aprovadas.")
    ...
    def reject_requests(self, request, queryset):
        ...
        self.message_user(request, f"{rejected_count} solicitações foram rejeitadas.")
...
class LeaveBalanceAdmin(admin.ModelAdmin):
    ...
    def dias_restantes_display(self, obj):
        ...
        return format_html(
            '<span style="color: {}; font-weight: bold;">{} dias</span>', color, restantes
        )
