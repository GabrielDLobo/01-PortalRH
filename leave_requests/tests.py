...
class LeaveTypeModelTestCase(TestCase):
    ...
    def test_leave_type_uniqueness(self):
        ...
        LeaveType.objects.create(nome="Atestado Médico", max_dias_ano=30, antecedencia_minima=0)
...
class LeaveRequestAuthorizationTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.hr_user = User.objects.create_user(
            username="leavehr@test.com",
            email="leavehr@test.com",
            password="testpass123",
            role="admin_rh",
        )
        self.employee_a = User.objects.create_user(
            username="leavea@test.com",
            email="leavea@test.com",
            password="testpass123",
            role="funcionario",
        )
        self.employee_b = User.objects.create_user(
            username="leaveb@test.com",
            email="leaveb@test.com",
            password="testpass123",
            role="funcionario",
        )
        self.leave_type = LeaveType.objects.create(
