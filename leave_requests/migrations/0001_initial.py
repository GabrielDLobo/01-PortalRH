    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "requer_aprovacao",
                    models.BooleanField(default=True, verbose_name="Requer aprovação"),
                ),
                (
                    "antecedencia_minima",
                    models.PositiveIntegerField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "data_aprovacao",
                    models.DateTimeField(blank=True, null=True, verbose_name="Data de Aprovação"),
                ),
                (
                    "comentario_aprovacao",
                    models.TextField(blank=True, verbose_name="Comentário da Aprovação"),
                ),
                (
                    "anexo",
                    models.FileField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "dias_disponiveis",
                    models.PositiveIntegerField(default=0, verbose_name="Dias Disponíveis"),
                ),
                (
                    "dias_utilizados",
                    models.PositiveIntegerField(default=0, verbose_name="Dias Utilizados"),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True, verbose_name="Criado em")),
                ("updated_at", models.DateTimeField(auto_now=True, verbose_name="Atualizado em")),
                (
